...
namespace Moro\Indexer\Common\Action\CheckEntity;
...
/**
 * Class CheckEntityAction
 * @package Moro\Indexer\Common\Action\CheckEntity
 */
class CheckEntityAction implements CheckEntityInterface
{
    /** @var SourceManager */
    protected $_source;
    /** @var IndexManager */
