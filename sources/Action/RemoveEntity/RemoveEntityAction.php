...
namespace Moro\Indexer\Common\Action\RemoveEntity;
 ...
 * @package Moro\Indexer\Common\Action\UpdateEntity
 */
class RemoveEntityAction implements RemoveEntityInterface
{
    /**
     * @var ViewManager
     */
